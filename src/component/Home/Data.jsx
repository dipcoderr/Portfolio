...
return (
    <div className='home-data'>
        <h1 className="home-title">Dipanshu Kumar Mishra
        <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
        ...
        <h3 className='home-subtitle'>FULL-STACK DEVELOPER & SOFTWARE ENGINEER</h3>
        <p className='home-description'>B.Tech in Electrical Engineering at NIT Agartala. Full-stack developer with expertise in MERN stack, RESTful APIs, and cloud integrations. Former SDE Intern at BlueStock, leading teams to build scalable applications. Competitive programmer: LeetCode 1807 | CodeChef 3★ (1611) | Codeforces Pupil (1322).</p>
